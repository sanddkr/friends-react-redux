...
2. Run `npm install`
3. Run `npm start`
This app allows you to search a robot from a group of robots and scroll will allow to gothrough list when app is minimized.
Here we added Redux for better state management if the app gets bigger using redux three principles
-----------------------------------
